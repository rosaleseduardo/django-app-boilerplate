...
4. Install [Pipenv](https://pipenv.pypa.io/en/latest/) globally in your machine.
5. Install [PostgreSQL](https://www.postgresql.org/download/) globally in your machine. Also, install the PostgreSQL interactive terminal (psql).
